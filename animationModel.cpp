...
void AnimationModel::Update(const char* AnimationName1, int Frame1, const char* AnimationName2, int Frame2,float BlendRatio)
{
	...
	aiNodeAnim* nodeAnim2 = nullptr;
		...
		bone->AnimationMatrix = aiMatrix4x4(aiVector3D(1.0, 1.0, 1.0), rot, pos);
	}
	aiMatrix4x4 rootMatrix = aiMatrix4x4(aiVector3D(1.0, 1.0, 1.0), aiQuaternion((float)AI_MATH_PI, 0.0f, 0.0f), aiVector3D(0.0, 0.0, 0.0));
