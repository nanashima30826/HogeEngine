...
void Renderer::Init()
{
	...
	samplerDesc.Filter = D3D11_FILTER_ANISOTROPIC;//見せ方
	...
	LIGHT light{};
	light.Enable = true;
	light.Direction = XMFLOAT4(0.0f, -0.5f, 1.0f, 0.0f);
	...
	Renderer::InitImGui(GetWindow());
	//Renderer::InitDirectX(GetWindow());
...
HRESULT Renderer::InitImGui(HWND hWnd)
{
	...
	HRESULT hr = ImGui_ImplDX11_Init(m_Device, m_DeviceContext);
	if (FAILED(hr)) return hr;

	ImGui::StyleColorsDark();
	return S_OK;
}
HRESULT Renderer::InitDirectX(HWND hWnd)
{
